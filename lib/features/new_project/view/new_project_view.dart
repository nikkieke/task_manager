            ...
            children: [
              ...
              Container(
                ...
                child: TextFormInput(
                  keyboardType:TextInputType.name,
                  controller: details,
                  labelText: 'Input your project details..',
                  inputFormatters: [
                    FilteringTextInputFormatter.deny(RegExp('[ ]')),
                  ],
                ),
                ...
                children: [
                  SizedBox(
                    ...
                    child: ListView(
                      ...
                      children: const [
                        AddTeamMember(name: 'Robert', avatar: AppImage.avatar2,),
                        SizedBox(width: 10,),
                        AddTeamMember(name: 'Sophia', avatar: AppImage.avatar7,),
                      ],
                    ),
                  ),
                  Space(10.w),
              ...
              const Row(
                children: [
                  AddTimeDate(text: '10:30 AM', icon: AppImage.clock,),
                  Space(20),
                  AddTimeDate(text: '15/11/2022', icon: AppImage.calendarLinear,),
                ],
              ),
              Space(21.h),
              Row(
...
class AddTimeDate extends StatelessWidget {
  const AddTimeDate({
    required this.text,
    required this.icon,
    super.key,
